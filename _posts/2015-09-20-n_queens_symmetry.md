...
This solution only has two more lines of code than the first solution shown above (don't forget to delete the comments), and runs in less than half the time. 
